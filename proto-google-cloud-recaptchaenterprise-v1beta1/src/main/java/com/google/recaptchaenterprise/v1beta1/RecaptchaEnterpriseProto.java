...
public final class RecaptchaEnterpriseProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "Bgoogle/cloud/recaptchaenterprise/v1beta1/recaptchaenterprise.proto\022(google.clo"
          ...
          + "assessment\030\002"
          + " \001(\01324.google.cloud.recaptchaenterprise.v1beta1.AssessmentB\003\340A\002\"\223\002\n"
          + "\031AnnotateAssessmentRequest\022C\n"
          + "\004name\030\001 \001(\tB5\340A\002\372A/\n"
          + "-recaptchaenterprise.googleapis.com/Assessment\022g\n\n"
          + "annotation\030\002"
          + " \001(\0162N.google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.AnnotationB\003\340A\002\"H\n\n"
          + "Annotation\022\032\n"
          + "\026ANNOTATION_UNSPECIFIED\020\000\022\016\n\n"
          + "LEGITIMATE\020\001\022\016\n\n"
          + "FRAUDULENT\020\002\"\034\n"
          + "\032AnnotateAssessmentResponse\"\312\004\n\n"
          + "Assessment\022\021\n"
          ...
          + " \001(\01329.google.cloud.recaptchaenterprise.v1beta1.TokenPropertiesB\003\340A\003\022_\n"
          + "\007reasons\030\005"
          + " \003(\0162I.google.cloud.recaptchaenterprise.v1beta1.Assessment.ClassificationReasonB\003\340A\003\"\270\001\n"
          ...
          + "-recaptchaenterprise.googleapis.com/Assessment\022+projects/{project}/assessments/{assessment}\"\207\001\n"
          + "\005Event\022\022\n"
          ...
          + "\017expected_action\030\005 \001(\tB\003\340A\001\"\350\002\n"
          + "\017TokenProperties\022\r\n"
          + "\005valid\030\001 \001(\010\022_\n"
          + "\016invalid_reason\030\002"
          + " \001(\0162G.google.cloud.recaptchaenterprise.v1beta1.TokenProperties.InvalidReason\022/\n"
          ...
          + "SITE_MISMATCH\020\005\022\013\n"
          + "\007MISSING\020\006\"\230\001\n"
          + "\020CreateKeyRequest\022C\n"
          + "\006parent\030\001 \001(\tB3\340A\002\372A-\n"
          + "+cloudresourcemanager.googleapis.com/Project\022?\n"
          + "\003key\030\002"
          + " \001(\0132-.google.cloud.recaptchaenterprise.v1beta1.KeyB\003\340A\002\"\207\001\n"
          ...
          + "\004keys\030\001 \003(\0132-.google.cloud.recaptchaenterprise.v1beta1.Key\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"M\n\r"
          + "GetKeyRequest\022<\n"
          + "\004name\030\001 \001(\tB.\340A\002\372A(\n"
          + "&recaptchaenterprise.googleapis.com/Key\"\211\001\n"
          + "\020UpdateKeyRequest\022?\n"
          + "\003key\030\001"
          + " \001(\0132-.google.cloud.recaptchaenterprise.v1beta1.KeyB\003\340A\002\0224\n"
          ...
          + " \001(\01328.google.cloud.recaptchaenterprise.v1beta1.WebKeySettingsH\000\022X\n"
          + "\020android_settings\030\004"
          + " \001(\0132<.google.cloud.recaptchaenterprise.v1beta1.AndroidKeySettingsH\000\022P\n"
          + "\014ios_settings\030\005"
          + " \001(\01328.google.cloud.recaptchaenterprise.v1beta1.IOSKeySettingsH\000:J\352AG\n"
          ...
          + "\021allow_amp_traffic\030\002 \001(\010\022g\n"
          + "\020integration_type\030\004"
          + " \001(\0162H.google.cloud.recaptchaenterprise.v1beta1.WebKeySettings.IntegrationTypeB\003\340A\002\022{\n"
          + "\035challenge_security_preference\030\005"
          + " \001(\0162T.google.cloud.recaptchaenterprise.v1beta1.WebKeySettings.ChallengeSecurityPreference\"t\n"
          + "\017IntegrationType\022 \n"
          + "\034INTEGRATION_TYPE_UNSPECIFIED\020\000\022\016\n\n"
          + "SCORE_ONLY\020\001\022\026\n"
          + "\022CHECKBOX_CHALLENGE\020\002\022\027\n"
          ...
          + "\020CreateAssessment\022A.google.cloud.recaptchaenterprise.v1beta1.CreateAssessmentRequest\0324.google.cloud.recaptchaenterprise.v1beta1.Assessment\"P\202\323\344\223\0026\"(/v1beta1/{parent=projects/*}/assessments:\n"
          + "assessment\332A\021parent,assessment\022\357\001\n"
          + "\022AnnotateAssessment\022C.google.cloud.recaptchaenterprise.v1beta1.AnnotateA"
          + "ssessmentRequest\032D.google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentResponse\"N\202\323\344\223\0026\"1/v1beta1/{name=projects/*/assessments/*}:annotate:\001*\332A\017name,annotation\022\246\001\n"
          + "\tCreateKey\022:.google.cloud.recaptchaenterprise.v1beta1.CreateKeyRequest\032-.google.cloud.recaptchaenterprise.v1beta1.Key\".\202\323\344\223\002(\"!/v1beta1/{parent=projects/*}/keys:\003key\022\254\001\n"
          + "\010ListKeys\0229.google.cloud.recaptchaenterprise.v1beta1.ListKeysRequest\032:.google.cloud.recaptchaenterprise.v1beta1.ListKeysResponse\")\202\323\344\223\002#\022!/v1beta1/{parent=projects/*}/keys\022\233\001\n"
          + "\006GetKey\0227.google.cloud.recaptchaenterprise.v1beta1.GetKeyRequest\032-.google.cloud.recaptchaenterprise.v1beta1.Key\")\202\323\344\223\002#\022!/v1beta1/{name=projects/*/keys/*}\022\252\001\n"
          + "\tUpdateKey\022:.google.cloud.recaptchaenterprise.v1"
          + "beta1.UpdateKeyRequest\032-.google.cloud.recaptchaenterprise.v1beta1.Key\"2\202\323\344\223\002,2%/v1beta1/{key.name=projects/*/keys/*}:\003key\022\212\001\n"
          + "\tDeleteKey\022:.google.cloud.recaptchaenterprise.v1beta1.DeleteKeyRequest\032\026.go"
          + "ogle.protobuf.Empty\")\202\323\344\223\002#*!/v1beta1/{name=projects/*/keys/*}\032V\312A\"recaptchaenterprise.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\254\002\n"
          + "&com.google.recaptchaenterprise.v1beta1B\030Recap"
          + "tchaEnterpriseProtoP\001Z[google.golang.org/genproto/googleapis/cloud/recaptchaente"
          ...
          + "V1beta1\352\002+Google::Cloud::RecaptchaEnterprise::V1beta1b\006proto3"
    };
    descriptor =
